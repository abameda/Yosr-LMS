...
Architecture Decision Records capture approved choices that materially shape implementation.
...
New decisions should use the next numeric identifier and link to affected specifications.
